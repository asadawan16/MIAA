...
export default function GalaIntroSection() {
  return (
    <section className="relative pt-8 md:pt-24 pb-20 md:pb-48 overflow-hidden bg-accent-cream">
      ...
      {/* Section divider */}
      <div className="relative z-10 mb-10 max-w-[1400px] mx-auto">
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 md:px-10 lg:px-16">
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-16">
          ...
          <motion.div {...fadeInLeft} className="flex-1">
            <h2 className="font-display text-2xl md:text-3xl font-medium text-primary leading-tight tracking-wide mb-6 uppercase">
              From Vision to Reality<br />Architectural Design Reveal
            </h2>
            <div className="flex flex-col gap-4 text-base text-primary leading-relaxed font-medium tracking-wide max-w-[500px]">
              <p>
          ...
          <motion.div {...fadeInRight} className="flex-1 flex flex-col gap-10">
            ...
            <div className="flex flex-col items-start">
              <div className="border border-white bg-white p-1 shadow-lg w-full max-w-[220px] md:max-w-[260px]">
                <img
                  src={artHorse}
              ...
              <p className="text-[9px] text-black mt-2 italic leading-snug max-w-[260px]">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
              <p className="text-[9px] text-black italic leading-snug sm:max-w-[120px]">
                One Thousand and One and Counting (1004 and counting) ~ <span className="font-semibold">Abdullah MI Syed</span>
              </p>
              <div className="border border-white bg-white p-1 shadow-lg w-full max-w-[300px] md:max-w-[380px] flex-shrink-0">
                <img
                  src={artGrill}
